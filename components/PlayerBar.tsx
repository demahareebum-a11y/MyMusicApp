      ...
      <div className="md:hidden px-3 py-2">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <button
              onClick={togglePlay}
              className="w-9 h-9 bg-white rounded-full flex items-center justify-center text-black active:scale-95 transition-transform"
            >
              {isPlaying
        ...
        <div className="flex-1 flex flex-col items-center gap-1 max-w-xl">
          <div className="flex items-center gap-5">
            ...
            <button
              ...
              className={`transition-colors ${repeat !== "off" ? "text-green-400" : "text-zinc-400 hover:text-white"}`}
            >
